...
export function SuccessScreen({
  ...
  const summaryItems = [
    ...
    ...(driverName
      ? [
          {
            label: "Motorista",
            value: driverName.split(" ").slice(0, 2).join(" "),
          },
        ]
      : []),
  ...
  return (
    <div
      ...
      style={{ backgroundColor: isReceipt ? "#0f2744" : primaryColor }}
    >
      ...
      >
        {!isReceipt && (
          <>
            ...
            <div
              className="w-24 h-24 rounded-full flex items-center justify-center mb-5 mt-4"
            ...
            >
              {isCheckin ? "Entrada Liberada!" : "Saída Liberada!"}
            </h1>
            <p
        ...
        {/* Summary card */}
        <div
          className={`w-full bg-white rounded-2xl overflow-hidden ${isReceipt ? "mt-4" : ""}`}
        ...
        >
          <div
            ...
            style={{
              ...
              borderBottom: `2px solid ${iconColor}20`,
            }}
          >
            <div
            ...
            {summaryItems.map((item) => (
              ...
              >
                ...
                <span
                  ...
                  style={{
                    color: item.label === "Protocolo" ? iconColor : "#1e293b",
                    letterSpacing:
                      item.label === "Placa" ? "0.06em" : undefined,
                  }}
                >
                  {item.value}
                </span>
